...
function NpmDir(root) {
  ...
  this.writePackageJson = (pies) => {
    ...
    //TODO: shouldn't have to install these - they should be installed in serve-pie and loaded from there
    dependencies['style-loader'] = '~0.13.1';
    dependencies['css-loader'] = '~0.25.0';
    dependencies['less-loader'] = '~2.2.3';
    dependencies['less'] = '~2.7.1';
