...
module.exports = (opts) => {
  ...
  let runBowerInstall = () => {
    if (bowerDir.isInstalled() && !opts.fullInstall) {
      ...
      /** 
       * TODO: These components were tests for accessiblity.
       * To re-enable them uncomment here and add the components to the control-panel.
       * @see: 
       * https://bitbucket.org/pietools/serve-pie/src/003a1a0e93ac248e108b18fd2b5bed251b8e873c/lib/server/views/sample-item/render.jade?at=master&fileviewer=file-view-default
       * 
       * For an example.
       *  
