function Router(dirname, itemData, resolutionReport) {
  ...
  router.get('/', function (req, res, next) {
    ...
    let container = '/js/pie/container.js';
    let frameworkSupportPaths = {js: []};
    
    if (angularIds.length > 0) {
      frameworkSupportPaths.js.push('/js/pie/angular-1.5/angular-elements-two.js');
    }

    if (reactIds.length > 0) {
      frameworkSupportPaths.js.push('/js/pie/react-15.0.1/react-elements.js');
    }
    ...
    res.render('sample-item/render', {
      name: dirname,
      js: _.concat(reduced.js , frameworkSupportPaths.js, [container]),
      css: reduced.css || [],
